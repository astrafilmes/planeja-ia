...
function M2AStatusBadge({ status }: { status: string }) {
  ...
  > = {
    ...
    pendente: {
      label: "Pendente",
      cls: "border-slate-200 bg-slate-50 text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-400",
      Icon: Clock,
    },
  };
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                {shouldAskFiscal ? (
                  ...
                  <div className="rounded-xl border border-slate-200 bg-slate-50 p-3 text-[13px] text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-3 dark:border-slate-800 dark:bg-slate-900">
              ...
              <div className="mt-2 flex max-h-48 flex-col gap-1 overflow-auto pr-1">
                {selectedContracts.slice(0, 8).map((contrato) => (
                  <div
                    key={contrato.id}
                    className="rounded-lg border border-slate-200 px-2 py-1.5 text-xs dark:border-slate-800"
                  >

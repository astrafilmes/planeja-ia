  ...
  function abrirConfirmacaoProcessoM2A() {
    ...
    if (rowsMissingM2A.length > 0) {
      toast.error("Ha planilhas sem IDs M2A cadastrados.", {
        description:
          "Complete Unidade Gestora e Unidade Orcamentaria em /secretarias.",
      });
      return;
    }
              ...
              <div className="mb-4 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-[#0B0F19]">
                ...
                <div className="grid gap-3 md:grid-cols-3">
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <select
                      className="h-10 rounded-md border border-slate-300 bg-white px-3 text-sm dark:border-slate-800 dark:bg-slate-950"
      ...
      <Dialog open={m2aConfirmOpen} onOpenChange={setM2aConfirmOpen}>
        <DialogContent className="max-w-2xl">
          ...
          <div className="grid gap-3 text-sm">
            <div className="grid gap-2 rounded-lg border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950 md:grid-cols-3">
              <div>
            ...
            <div className="rounded-lg border border-slate-200 dark:border-slate-800">
              ...
              <div className="max-h-64 overflow-auto">
                {selectedImportRows.map((row) => (
                  <div
                    key={row.key}
                    className="grid gap-2 border-b border-slate-100 px-3 py-2 text-[13px] last:border-b-0 dark:border-slate-800 md:grid-cols-[1fr_120px_120px]"
                  >

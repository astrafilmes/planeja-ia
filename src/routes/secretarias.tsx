...
export const Route = createFileRoute("/secretarias")({
 ...
 path:"/secretarias",
 title:"Secretarias",
 description:"Cadastre e organize as secretarias requisitantes participantes do planejamento de contratações.",
 }),
});
...
function Page() {
 ...
 <AlertDialogDescription>"{deleting?.nome}" será removida do cadastro. Essa ação não altera

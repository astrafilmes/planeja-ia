            ...
            <CardContent className="p-0">
              <div>
                {(jobs ?? []).map((j) => (
                  <div
                    key={j.id}
                    className={`group relative w-full border-b border-slate-200 transition-colors hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800/50 ${activeJobId === j.id ? "bg-slate-50 dark:bg-slate-800/50" : ""}`}
                  >
                    <button
                      type="button"
                    ...
                    <AlertDialog>
                      ...
                      >
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            "{j.original_filename}" será removida com seus itens
                        ...
                        <Collapsible key={c.key} defaultOpen={false}>
                          <Card className="overflow-hidden border-slate-200 dark:border-slate-800">
                            ...
                            <CollapsibleContent>
                              ...
                              <CardContent className="border-t border-slate-200 p-0 dark:border-slate-800">
                      ...
                      <TableBody>
                        {jobDetail.itens.map((i: any) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <select
                                className="h-9 w-full rounded-md border border-slate-300 bg-white px-2 text-[13px] transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-950"
                        ...
                        <>
                          ...
                          <div className="flex flex-col gap-3 rounded-xl border border-slate-200 p-3 dark:border-slate-800">
                            ...
                            <div className="flex flex-col gap-1.5">
                              ...
                              <select
                                className="h-10 w-full rounded-md border border-slate-300 bg-white px-2 text-sm transition-all focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-950"
                                value={processoId}
                          ...
                          <div className="flex flex-col gap-3 rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-[#0B0F19]">
                                ...
                                <div className="flex max-h-56 flex-col gap-2 overflow-auto pr-1">
                                  {fornecedoresPrepostoTargets.map((target) => {
                                    ...
                                    return (
                                      <div
                                        key={target.key}
                                        className="grid gap-2 rounded-xl border border-slate-200 bg-white px-2.5 py-2 dark:border-slate-800 dark:bg-slate-900 md:grid-cols-[1fr_260px]"
                                      >
                                        <div className="min-w-0">
                                          <div
                            ...
                            <div className="rounded-xl border border-slate-200 bg-white p-3 text-[13px] text-slate-600 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300">

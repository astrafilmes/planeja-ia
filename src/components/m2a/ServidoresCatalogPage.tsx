              ...
              <div className="grid max-h-72 gap-2 overflow-y-auto rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-muted/30 md:grid-cols-2">
                {unidades.map((unidade) => (
                  <label
                    ...
                    className="flex cursor-pointer items-center gap-2 rounded-md px-2 py-1.5 text-sm text-slate-700 transition-colors hover:bg-white dark:text-slate-300 dark:hover:bg-slate-900"
                  >
                    <Checkbox

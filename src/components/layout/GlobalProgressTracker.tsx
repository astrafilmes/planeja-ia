...
export function GlobalProgressTracker() {
  ...
  return (
    <section
      ...
      className="fixed inset-x-4 bottom-4 z-50 overflow-hidden rounded-xl border border-border/60 bg-card/95 shadow-lg backdrop-blur-md transition-all sm:inset-x-auto sm:bottom-6 sm:right-6 sm:w-96"
    >

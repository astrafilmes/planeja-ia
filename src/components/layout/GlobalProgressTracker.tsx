...
export function GlobalProgressTracker() {
  ...
  return (
    <section
      ...
      className="fixed inset-x-4 bottom-4 z-50 overflow-hidden rounded-xl border border-slate-200 bg-white/95 shadow-sm backdrop-blur-md transition-all dark:border-slate-800 dark:bg-slate-900/95 sm:inset-x-auto sm:bottom-6 sm:right-6 sm:w-80"
    >
